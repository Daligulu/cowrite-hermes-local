...
name: humanizer-zh
description: |
  去除中文文本中的 AI 生成痕迹，让文案、文章、逐字稿更自然、更像真人表达。
  适用于编辑或审阅文本，识别并修复夸张象征意义、宣传腔、AI 词汇、三段式法则、
  破折号滥用、模糊归因、过多连接短语等常见“机器人味”。
  Triggers: 去 AI 味, 去机器人味, 文案人味化, 中文润色, humanizer, HumanizerZH, 文章改写, 逐字稿润色
triggers:
  - 去 AI 味
  - 去机器人味
  - 文案人味化
