...
```
主色（石墨灰）：   #52525B（下划线 / 竖条专用）
正文色：           #3F3F46（正文段落 / 列表 / 卡片正文）
标题色（深炭）：   #27272A
深灰强调：         #3F3F46
...
正文字号：         16px（移动端阅读优化；旧版 15px 已弃用）
行高：             1.75（16px 字号的平衡值；旧版 1.8 已弃用）
字间距：           0.3px
最大宽度：         677px
内容区边距：       0 10px（左右各 10px）
章节间距：         56px（后续章节 margin-top）
段落长度上限：     150 字（超长段落自动拆段，移动端防"文字墙"）
```
...
```html
<section style="max-width:677px;margin:0 auto;background:#FFFFFF;font-family:-apple-system,BlinkMacSystemFont,'PingFang SC','Hiragino Sans GB','Microsoft YaHei',sans-serif;color:#3F3F46;line-height:1.75;letter-spacing:0.3px;overflow-x:hidden;">
...
```html
<p style="margin-bottom:24px;font-size:16px;line-height:1.75;text-align:justify;color:#3F3F46;letter-spacing:0.3px;">
  <span leaf="">{{正文内容}}</span>
</p>
```
...
```html
<p style="font-size:17px;font-weight:600;color:#27272A;margin:24px 0 10px;padding-left:12px;border-left:3px solid #52525B;line-height:1.5;">
  <span leaf="">{{子标题}}</span>
</p>
```
...
<section style="background:#FAFAFA;border:1px solid #E4E4E7;padding:20px 22px;margin:0 10px 28px;">
  ...
  <p style="font-size:16px;color:#3F3F46;margin:0;line-height:1.75;text-align:justify;">
...
<section style="border-left:3px solid #27272A;padding:14px 0 14px 22px;margin:0 10px 24px;">
  <p style="font-size:15px;font-weight:700;color:#27272A;margin:0;line-height:1.75;">
...
<section style="background:#FAFAFA;border-top:2px solid #27272A;padding:18px 22px;margin:0 10px 24px;">
  ...
  <p style="font-size:15px;color:#3F3F46;margin:0;line-height:1.75;">
...
<section style="margin-bottom:22px;">
  <section style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
    ...
    <span style="font-size:17px;font-weight:600;color:#27272A;"><span leaf="">{{步骤标题}}</span></span>
  </section>
  <p style="font-size:16px;margin:0 0 16px;color:#3F3F46;line-height:1.75;text-align:justify;">
    {{步骤内容}}
  </p>
</section>
```
...
<section style="margin-bottom:22px;">
  <section style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
    ...
    <span style="font-size:17px;font-weight:600;color:#27272A;"><span leaf="">{{名称}}</span></span>
  </section>
</section>
```
...
<section style="margin-bottom:24px;">
  <section style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;">
    ...
    <p style="font-size:16px;color:#3F3F46;margin:0;line-height:1.75;flex:1;"><span leaf="">{{列表项内容}}</span></p>
  </section>
  <section style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;">
...
<section style="display:flex;margin-bottom:24px;">
  ...
  <section style="flex:1;padding-bottom:12px;">
    <p style="margin:0 0 6px;font-size:17px;font-weight:600;color:#27272A;"><span leaf="">{{节点标题}}</span></p>
    <p style="font-size:16px;margin:0;color:#3F3F46;line-height:1.75;text-align:justify;">{{节点内容}}</p>
  </section>
</section>
```
...
<section style="margin:0 10px 24px;overflow-x:auto;">
  <table style="width:100%;border-collapse:collapse;font-size:14px;">
    ...
    <tbody>
      <tr>
        <td style="padding:8px 12px;border-bottom:1px solid #E4E4E7;color:#3F3F46;"><span leaf="">{{内容}}</span></td>
        <td style="padding:8px 12px;border-bottom:1px solid #E4E4E7;color:#3F3F46;"><span leaf="">{{内容}}</span></td>
      </tr>
      <tr>
        <td style="padding:8px 12px;border-bottom:1px solid #E4E4E7;color:#3F3F46;background:#FAFAFA;"><span leaf="">{{内容}}</span></td>
        <td style="padding:8px 12px;border-bottom:1px solid #E4E4E7;color:#3F3F46;background:#FAFAFA;"><span leaf="">{{内容}}</span></td>
      </tr>
    </tbody>
  </table>
...
<section style="padding:0 10px 24px;">
  <section style="border-top:1px solid #E4E4E7;padding-top:28px;">
    <p style="margin-bottom:16px;font-size:16px;line-height:1.75;color:#3F3F46;text-align:justify;">
      <span leaf="">我是 {{作者名}}，{{一句话简介，如：热衷于分享 AI 观察与干货}}。</span>
    </p>
    <p style="margin-bottom:0;font-size:16px;line-height:1.75;color:#3F3F46;text-align:justify;">
